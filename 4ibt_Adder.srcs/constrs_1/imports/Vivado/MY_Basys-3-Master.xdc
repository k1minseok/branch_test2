...
#set_property -dict { PACKAGE_PIN E19  IOSTANDARD LVCMOS33 } [get_ports { Sum1 }]; #IO_L3N_T0_DQS_EMCCLK_14      ,Sch=LED1
#set_property -dict { PACKAGE_PIN U19  IOSTANDARD LVCMOS33 } [get_ports { Sum2  }]; #IO_L15P_T2_DQS_RDWR_B_14     ,Sch=LED2
#set_property -dict { PACKAGE_PIN V19  IOSTANDARD LVCMOS33 } [get_ports { Sum3  }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 ,Sch=LED3
#set_property -dict { PACKAGE_PIN W18  IOSTANDARD LVCMOS33 } [get_ports { Carry  }]; #IO_L16P_T2_CSI_B_14          ,Sch=LED4
